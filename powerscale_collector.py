...
<aside class="sidebar">
  <div class="conn-panel">
    ...
    <div class="cr"><label>Cluster FQDN / IP</label>
      <input class="ci" id="cHost" type="text" placeholder="ps-mgmt.example.local" autocomplete="off" spellcheck="false"></div>
  ...
  <div class="card" style="margin-bottom:18px">
    ...
    <div class="cb" style="padding:14px">
      ...
      <div style="display:flex;gap:8px;align-items:center">
        <input class="fi" id="ntpServerInput" placeholder="192.0.2.11, 192.0.2.12" style="flex:1" onkeydown="if(event.key==='Enter')saveNTPServers()">
